			...
			<div class="col-md-4 col-md-offset-4">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title" align="center">ID 찾기</h3>
					</div>
					<div class="panel-body">
						<form action="find_id" method="post" accept-charset="UTF-8"
							role="form">
							<fieldset>
								<div class="form-group">
									<input class="form-control" placeholder="Email을 입력해주세요"
