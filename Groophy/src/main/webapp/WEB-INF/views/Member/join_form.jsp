					...
					<div class="card-body">
						...
						<form action="join" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>ID<span class="text-danger">*</span></label> <input
									type="text" id="uId" name="uId" class="form-control"
							...
							<div class="form-group">
								<label>닉네임<span class="text-danger">*</span></label> <input
									type="text" id="uNickName" name="uNickName"
									class="form-control" placeholder="닉네임을 입력해주세요">
							</div>
							<div class="form-group">
								<label>Email<span class="text-danger">*</span></label> <input
									type="email" id="uEmail" name="uEmail" class="form-control"
							...
							<div class="form-group">
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input"
										...
										class="custom-control-label" for="customControlAutosizing">본인은
										모든 <a href="terms.html">이용약관</a>에 동의합니다
									</label>
								</div>
							</div>
							<div class="form-group">
		...
		<div class="groophy_copyright">
			<p>
				<small><img src="assets/img/logo.png" class="copyrightlogo"
					style="width: 50px; height: 18px;"> Copyright © groophy All
